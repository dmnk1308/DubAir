...
def load_data_for_fold(random_seed = 123, test_split = 0.2, val_split = 0.2, for_dendro = False, drop_id = True, standardize = True, train_idx = None, val_idx = None, verbose = 0):
    url_listing = "http://data.insideairbnb.com/ireland/leinster/dublin/2021-11-07/data/listings.csv.gz"
    listings = pd.read_csv(url_listing)
